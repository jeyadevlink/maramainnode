...
struct Sidechain {
    ...
    SERIALIZE_METHODS(Sidechain,obj) {
        READWRITE(obj.fActive, obj.nSidechain, obj.nVersion, obj.title, obj.description, obj.hashID1, obj.hashID2);
    }
...
struct SidechainActivationStatus
{
    ...
    SERIALIZE_METHODS(SidechainActivationStatus,obj) {
        READWRITE(obj.nAge, obj.nFail);
    }
...
struct SidechainDeposit {
    ...
    SERIALIZE_METHODS(SidechainDeposit,obj) {
        READWRITE(obj.nSidechain, obj.strDest, obj.tx, obj.nBurnIndex, obj.nTx, obj.hashBlock);
    }
...
struct SidechainWithdrawalState {
    ...
    SERIALIZE_METHODS(SidechainWithdrawalState,obj) {
        READWRITE(obj.nSidechain, obj.nBlocksLeft, obj.nWorkScore, obj.hash);
    }
...
struct SidechainSpentWithdrawal {
    ...
    SERIALIZE_METHODS(SidechainSpentWithdrawal,obj) {
        READWRITE(obj.nSidechain, obj.hash, obj.hashBlock);
    }
...
struct SidechainFailedWithdrawal {
    ...
    SERIALIZE_METHODS(SidechainFailedWithdrawal,obj) {
        READWRITE(obj.nSidechain, obj.hash);
    }
...
struct SidechainCTIP {
    ...
    SERIALIZE_METHODS(SidechainCTIP,obj) {
        READWRITE(obj.out, obj.amount);
    }
...
struct SidechainBlockData: public SidechainObj {
    ...
    SERIALIZE_METHODS(SidechainBlockData,obj) {
        READWRITE(Using<VectorFormatter<DefaultFormatter>>(obj.vWithdrawalStatus));
        READWRITE(Using<VectorFormatter<DefaultFormatter>>(obj.vSpent));
        READWRITE(Using<VectorFormatter<DefaultFormatter>>(obj.vActivationStatus));
        READWRITE(Using<VectorFormatter<DefaultFormatter>>(obj.vSidechain));
    }
